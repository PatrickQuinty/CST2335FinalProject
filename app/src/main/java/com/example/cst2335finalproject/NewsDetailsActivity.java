...
import static com.example.cst2335finalproject.MyDatabaseOpenHelper.COL_ID;
import static com.example.cst2335finalproject.MyDatabaseOpenHelper.KEY_DESCRIPTION;
import static com.example.cst2335finalproject.MyDatabaseOpenHelper.KEY_TITLE;
import static com.example.cst2335finalproject.MyDatabaseOpenHelper.KEY_URL;
import static com.example.cst2335finalproject.MyDatabaseOpenHelper.KEY_URLTOIMAGE;
import static com.example.cst2335finalproject.NewsMainActivity.KEY_POS;
import static com.example.cst2335finalproject.NewsMainActivity.KEY_SAVED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Save the data to the dataBase
         saveButton.setOnClickListener(click -> {
             ...
             newRowValues.put(KEY_TITLE,title);
             newRowValues.put(KEY_DESCRIPTION,description);
             newRowValues.put(KEY_URL,url);
             newRowValues.put(KEY_URLTOIMAGE,imageUrl);
